...
export default function MovieDetailDialog({ 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="retro-panel border-4 border-retro-magenta shadow-retro-lg max-w-5xl max-h-[95vh] overflow-y-auto p-0">
        ...
        <div className="relative z-10">
          ...
          <div className="relative aspect-video bg-gradient-to-br from-retro-purple/20 to-muted">
