  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background">
      <div className="flex flex-col items-center justify-center px-4 py-16 max-w-2xl mx-auto">
        ...
        <div className="bg-card/90 border-4 border-retro-teal p-8 mb-6 retro-border-clip shadow-retro-lg max-w-xl w-full">
        ...
        <div className="mb-8 flex items-center gap-3 bg-card/60 border-2 border-retro-teal/50 px-6 py-3">
          <RotateCw
            className={`w-5 h-5 text-retro-teal ${isRetrying ? 'animate-spin' : 'animate-pulse'}`}
          />
          <p className="retro-body text-retro-teal text-base">
            {isRetrying
              ? 'ПОДКЛЮЧЕНИЕ...'
              : `АВТОПОВТОР ЧЕРЕЗ ${retryCountdown} СЕК`}
          </p>
        </div>
